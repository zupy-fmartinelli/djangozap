...
MIGRATION_MODULES = {"sites": "djangozap.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "djangozap.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
ADMINS = [("""Fabio Martinelli""", "webmaster@zupy.com.br")]
...
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "djangozap.users.forms.UserSocialSignupForm"}
# django-compressor
# ------------------------------------------------------------------------------
...
SPECTACULAR_SETTINGS = {
    "TITLE": "DjangoZap API",
    "DESCRIPTION": "Documentation of API endpoints of DjangoZap",
    "VERSION": "1.0.0",
